...
It is using the Rails Admin gem to manually input data right now and that is being done by other friends who have no experience with coding. 

You can view the work in progress here: http://beatarea.herokuapp.com/
